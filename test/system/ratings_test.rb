...
class RatingsTest < ApplicationSystemTestCase
  ...
  test "creating a Rating" do
    ...
    fill_in "Fun type", with: @rating.fun_type
    fill_in "Suggested direction", with: @rating.suggested_direction
    fill_in "Water requirement", with: @rating.water_requirement
